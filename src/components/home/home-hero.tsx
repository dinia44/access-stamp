...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#04122B] via-[#061A3A] to-[#0B1D46] text-[#F8FAFC]">
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_88%_12%,rgba(34,211,238,0.1),transparent_42%),radial-gradient(circle_at_12%_88%,rgba(37,99,235,0.14),transparent_45%)]"
        aria-hidden="true"
      />
      <div
      ...
      />
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#030B1A] to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-12 lg:px-8 lg:pb-24">
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-14">
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-[1.02] tracking-[-0.045em] text-[#F8FAFC] sm:text-5xl lg:text-6xl">
              Find accessible places with confidence.
            </h1>

            <p className="mt-5 max-w-xl text-lg leading-8 text-[#E2E8F0] sm:text-xl">
