...
export const HOME_INPUT = `h-14 min-h-[44px] w-full rounded-2xl border border-[#E8C4A8] bg-white px-4 text-base text-[#13201F] placeholder:text-[#5E6A66]/80 transition-all duration-200 focus:border-[var(--color-primary)] focus:outline-none focus:ring-4 focus:ring-[var(--color-primary)]/15 ${HOME_FOCUS}`;

export const HOME_BTN_PRIMARY = `inline-flex min-h-[44px] h-14 items-center justify-center gap-2 rounded-full bg-[var(--color-primary)] px-6 text-base font-semibold text-white shadow-[0_8px_24px_-8px_rgba(184,58,18,0.4)] transition-all duration-200 hover:bg-[var(--color-primary-hover)] ${HOME_FOCUS}`;
...
export const HOME_BTN_GHOST = `inline-flex min-h-[44px] items-center justify-center gap-2 rounded-2xl border border-[#E8C4A8] bg-white px-5 text-base font-semibold text-[#13201F] transition-all duration-200 hover:border-[var(--color-primary)]/40 hover:bg-[#FFF3E8] hover:text-[#13201F] ${HOME_FOCUS}`;
...
export function homeChipClass(active: boolean) {
  ...
  return active
    ? `${base} border-[var(--color-primary)] bg-[#FFE2D3] text-[#13201F] shadow-sm shadow-[var(--color-primary)]/10`
