    ...
    <header className="nav-header sticky top-0 z-50 backdrop-blur-md">
      <Container>
        <div className="relative z-20 flex h-16 items-center justify-between gap-3">
          ...
          <button
            type="button"
            className="shrink-0 rounded-[var(--radius-ui)] px-3 py-2 text-sm font-semibold text-heading hover:bg-background-2 lg:hidden [touch-action:manipulation]"
        ...
        {mobileOpen ? (
          <nav className="pb-4 lg:hidden" aria-label="Mobile">
