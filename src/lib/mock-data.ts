...
export const SAMPLE_VENUES: Venue[] = [
  ...
  },
  {
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1559305616-3f99cd43e353?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    photos: [
      ...
      {
        src: "https://images.unsplash.com/photo-1524712245354-2c4e5e7121c0?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    photos: [
      ...
      {
        src: "https://images.unsplash.com/photo-1416169607655-0c2b3ce2e067?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    rating: 4.8,
    summary:
      "Lift access to all galleries, spacious circulation routes, accessible toilets on each floor, and Blue Badge parking close to the entrance.",
    tags: ["Lift access", "Step-free", "Accessible toilet", "Hearing loop"],
    verification: "Access Stamp checked",
    lastUpdated: "May 2026",
    confidence: "High",
    features: {
    ...
    photos: [
      {
        ...
        alt: "Royal Armouries Museum exterior with wide level approach",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "brighton-pier-pavilion",
    name: "Brighton Pier Pavilion",
    location: "Brighton, East Sussex",
    type: "Leisure",
    rating: 4.2,
    summary:
      "Level boardwalk access to the main pavilion, accessible toilet near the entrance, and staff can advise on quieter visiting times.",
    tags: ["Step-free", "Accessible toilet", "Family friendly"],
    verification: "Community reported",
    lastUpdated: "May 2026",
    confidence: "Medium",
    features: {
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1529651737248-dad5eba964b5?auto=format&fit=crop&w=1200&q=80",
        alt: "Brighton seafront pier on a sunny day",
        label: "Venue overview",
      },
    ],
  },
  {
    ...
    name: "Central Library Birmingham",
    location: "Birmingham, B1",
    type: "Arts & Culture",
    rating: 4.5,
    summary:
      "Step-free entrance, lift to all public floors, hearing loop at service desks, and accessible toilets on the ground and first floors.",
    tags: ["Lift access", "Hearing loop", "Step-free"],
    verification: "Access Stamp checked",
    lastUpdated: "May 2026",
    confidence: "High",
    features: {
    ...
    photos: [
      {
        ...
        alt: "Modern library interior with wide aisles and natural light",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "meadowhall-food-hall-sheffield",
    name: "Meadowhall Food Hall",
    location: "Sheffield, S9",
    type: "Shopping",
    rating: 4.3,
    summary:
      "Powered wheelchair friendly food court with level access, lift links to car parks, and accessible toilets throughout the centre.",
    tags: ["Power chair OK", "Lift access", "Accessible toilet"],
    verification: "Community reported",
    lastUpdated: "May 2026",
    confidence: "Medium",
    features: {
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1441986300917-64676bd600d8?auto=format&fit=crop&w=1200&q=80",
        alt: "Bright shopping centre interior with wide walkways",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "castle-view-restaurant-edinburgh",
    name: "Castle View Restaurant",
    location: "Edinburgh, EH1",
    type: "Restaurant",
    rating: 4.6,
    summary:
      "Step-free side entrance, spacious dining layout, accessible toilet, and nearby Blue Badge bays on the Royal Mile approach.",
    tags: ["Step-free", "Spacious", "Blue Badge nearby"],
    verification: "Access Stamp checked",
    lastUpdated: "May 2026",
    confidence: "High",
    features: {
    ...
    photos: [
      {
        ...
        alt: "Restaurant dining room with warm lighting and space between tables",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "tate-st-ives-gallery",
    name: "Tate St Ives Gallery",
    location: "St Ives, Cornwall",
    type: "Arts & Culture",
    rating: 4.4,
    summary:
      "Lift to upper galleries, step-free ground floor routes, accessible toilet, and staff support for planning quieter visits.",
    tags: ["Lift access", "Quiet space", "Accessible toilet"],
    verification: "Community reported",
    lastUpdated: "May 2026",
    confidence: "Medium",
    features: {
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1561214115-f2f967c95261?auto=format&fit=crop&w=1200&q=80",
        alt: "Contemporary art gallery interior with wide open floor space",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "cardiff-community-hub",
    name: "Cardiff Community Hub",
    location: "Cardiff, CF10",
    type: "Healthcare",
    rating: 4.5,
    summary:
      "Fully step-free community space with automatic doors, hearing loop at reception, accessible toilet, and trained staff on site.",
    tags: ["Step-free", "Hearing loop", "Staff trained"],
    verification: "Access Stamp checked",
    lastUpdated: "May 2026",
    confidence: "High",
    features: {
    ...
    photos: [
      {
        ...
        alt: "Bright community workspace with wide corridors",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "pump-room-tea-room-bath",
    name: "Pump Room Tea Room",
    location: "Bath, Somerset",
    type: "Café",
    rating: 4.7,
    summary:
      "Historic tea room with ramped entrance, accessible toilet, flexible seating, and a quieter area available on request.",
    tags: ["Step-free", "Quiet space", "Accessible toilet"],
    verification: "Community reported",
    lastUpdated: "May 2026",
    confidence: "Medium",
    features: {
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1559928712-57894d9f1b4f?auto=format&fit=crop&w=1200&q=80",
        alt: "Elegant tea room interior with high ceilings and natural light",
        label: "Venue overview",
      },
    ],
  },
  {
    slug: "norwich-cathedral-refectory",
    name: "Norwich Cathedral Refectory",
    location: "Norwich, Norfolk",
    type: "Café",
    rating: 4.4,
    summary:
      "Level access from the close, wide doorways, accessible toilet nearby, and calm seating away from the main counter.",
    tags: ["Step-free", "Quiet space", "Accessible toilet"],
    verification: "Not yet verified",
    lastUpdated: "May 2026",
    confidence: "Low",
    ...
    photos: [
      {
        src: "https://images.unsplash.com/photo-1445118986648-6317852a0a4c?auto=format&fit=crop&w=1200&q=80",
        alt: "Historic cathedral close with level paving stones",
        label: "Venue overview",
      },
    ],
  },
